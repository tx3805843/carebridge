...
insert into auth.users (id, email, raw_user_meta_data, instance_id, aud, role) values
  ('a0000000-0000-0000-0000-000000000000', 'admin@carebridge.dev', jsonb_build_object('full_name', 'Kwame Owusu', 'phone', '+233244000000', 'role_id', (select id from "role" where slug = 'admin')), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a0000000-0000-0000-0000-000000000001', 'coordinator1@carebridge.dev', jsonb_build_object('full_name', 'Abena Frimpong', 'phone', '+233244000001', 'role_id', (select id from "role" where slug = 'coordinator')), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a0000000-0000-0000-0000-000000000002', 'coordinator2@carebridge.dev', jsonb_build_object('full_name', 'Yaw Boateng', 'phone', '+233244000002', 'role_id', (select id from "role" where slug = 'coordinator')), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a0000000-0000-0000-0000-000000000003', 'director@carebridge.dev', jsonb_build_object('full_name', 'Dr. Efua Mensah', 'phone', '+233244000003', 'role_id', (select id from "role" where slug = 'clinical_director')), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a0000000-0000-0000-0000-000000000004', 'nurse1@carebridge.dev', jsonb_build_object('full_name', 'Adjoa Asante', 'phone', '+233244000004', 'role_id', (select id from "role" where slug = 'nurse')), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a0000000-0000-0000-0000-000000000005', 'nurse2@carebridge.dev', jsonb_build_object('full_name', 'Kofi Owusu', 'phone', '+233244000005', 'role_id', (select id from "role" where slug = 'nurse')), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a0000000-0000-0000-0000-000000000006', 'nurse3@carebridge.dev', jsonb_build_object('full_name', 'Akosua Darko', 'phone', '+233244000006', 'role_id', (select id from "role" where slug = 'nurse')), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a0000000-0000-0000-0000-000000000007', 'caregiver1@carebridge.dev', jsonb_build_object('full_name', 'Kwabena Appiah', 'phone', '+233244000007', 'role_id', (select id from "role" where slug = 'caregiver')), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a0000000-0000-0000-0000-000000000008', 'caregiver2@carebridge.dev', jsonb_build_object('full_name', 'Ama Boateng', 'phone', '+233244000008', 'role_id', (select id from "role" where slug = 'caregiver')), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a0000000-0000-0000-0000-000000000009', 'caregiver3@carebridge.dev', jsonb_build_object('full_name', 'Yaa Asantewaa', 'phone', '+233244000009', 'role_id', (select id from "role" where slug = 'caregiver')), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a000000a-0000-0000-0000-00000000000a', 'yaw.asante@example.co.uk', jsonb_build_object('full_name', 'Yaw Asante', 'phone', '+441234500001'), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a000000b-0000-0000-0000-00000000000b', 'adjoa.ntim@example.com', jsonb_build_object('full_name', 'Adjoa Ntim', 'phone', '+233244000011'), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
  ('a000000c-0000-0000-0000-00000000000c', 'kojo.serwaa@example.com', jsonb_build_object('full_name', 'Kojo Serwaa', 'phone', '+12025550001'), '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated'),
